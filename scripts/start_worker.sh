...
NIGHT_WARM_INTERVAL="${WORKER_NIGHT_WARM_POLL_SECONDS:-${WORKER_NIGHT_WARM_POLL_INTERVAL_SECONDS:-600}}"
NIGHT_IDLE_INTERVAL="${WORKER_NIGHT_IDLE_POLL_SECONDS:-${WORKER_NIGHT_IDLE_POLL_INTERVAL_SECONDS:-1800}}"
...
export WORKER_NIGHT_START_HOUR="$NIGHT_START_HOUR"
export WORKER_NIGHT_END_HOUR="$NIGHT_END_HOUR"
export WORKER_NIGHT_WARM_POLL_SECONDS="$NIGHT_WARM_INTERVAL"
export WORKER_NIGHT_IDLE_POLL_SECONDS="$NIGHT_IDLE_INTERVAL"
export WORKER_NIGHT_WARM_POLL_INTERVAL_SECONDS="$NIGHT_WARM_INTERVAL"
export WORKER_NIGHT_IDLE_POLL_INTERVAL_SECONDS="$NIGHT_IDLE_INTERVAL"
...
echo "worker started: $LABEL mode=adaptive_loop active=${ACTIVE_INTERVAL}s warm=${WARM_INTERVAL}s idle=${IDLE_INTERVAL}s night=${NIGHT_START_HOUR}:00-${NIGHT_END_HOUR}:00 night_warm=${NIGHT_WARM_INTERVAL}s night_idle=${NIGHT_IDLE_INTERVAL}s idle_backoff=${IDLE_BACKOFF_AFTER_CHECKS} warm_checks=${WARM_CHECKS_AFTER_ACTIVITY} log=$LOG launch_log=$LAUNCH_LOG"
