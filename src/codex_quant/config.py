...
QUANT_SYSTEM_GAP_REPORT = REPORTS_DIR / "quant_system_gap_report.md"
BACKTEST_BASELINE_REPORT = REPORTS_DIR / "backtest_baseline_report.md"
QUANT_BASELINE_REPLAY_CSV = REPORTS_DIR / "quant_baseline_replay.csv"
QUOTE_REPLAY_FIXTURE = DATA_DIR / "replay" / "silver_option_quote_replay.csv"
TICK_REPLAY_FIXTURE = DATA_DIR / "replay" / "silver_option_tick_smoke.csv"
TICK_FILE_SMOKE_REPORT = REPORTS_DIR / "tick_file_smoke_report.md"
